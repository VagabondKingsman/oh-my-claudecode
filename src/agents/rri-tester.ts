...
export const RRI_TESTER_PROMPT_METADATA: AgentPromptMetadata = {
  category: 'specialist',
  cost: 'CHEAP',
...
export const rriTesterAgent: AgentConfig = {
  name: 'rri-tester',
  description:
    'RRI-T specialist (Sonnet). Runs 5 testing personas × 7 dimensions × 8 stress axes, generates Q→A→R→P→T test cases, records a 4-level verdict (PASS / FAIL / PAINFUL / MISSING) per case, computes a Module × Dimension coverage matrix, and emits a release-gate decision for the vibecodekit-hybrid pipeline.',
