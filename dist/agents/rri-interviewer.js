...
export const RRI_INTERVIEWER_PROMPT_METADATA = {
    category: 'specialist',
    cost: 'CHEAP',
...
export const rriInterviewerAgent = {
    name: 'rri-interviewer',
    description: 'Reverse Requirements Interview specialist (Sonnet). Runs a structured 5-persona × 3-mode interview, consumes the SCAN report to skip auto-answered questions, and produces a Requirements Matrix + Decisions Log + Open Questions artifact for the vibecodekit-hybrid pipeline.',
    prompt: loadAgentPrompt('rri-interviewer'),
    model: 'sonnet',
    defaultModel: 'sonnet',
    metadata: RRI_INTERVIEWER_PROMPT_METADATA,
};
//# sourceMappingURL=rri-interviewer.js.map