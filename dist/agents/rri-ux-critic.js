...
export const RRI_UX_CRITIC_PROMPT_METADATA = {
    category: 'specialist',
    cost: 'CHEAP',
...
export const rriUxCriticAgent = {
    name: 'rri-ux-critic',
    description: 'RRI-UX specialist (Sonnet). Runs 5 UX personas × 7 UX dimensions × 8 Flow Physics axes, produces 80-120 S→V→P→F→I issues per module, scores a UX Coverage Matrix, and emits a release-gate decision with Vietnamese-specific checklist when OMC_LOCALE=vi.',
    prompt: loadAgentPrompt('rri-ux-critic'),
    model: 'sonnet',
    defaultModel: 'sonnet',
    metadata: RRI_UX_CRITIC_PROMPT_METADATA,
};
//# sourceMappingURL=rri-ux-critic.js.map